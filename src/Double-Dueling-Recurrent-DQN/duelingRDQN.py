...
restoring_backup_name = "double-dueling-recurrent-dqn"
...
class LSTM():
    def __init__(self, rnn_cell, scope):
        ...
        # Let's print the important information
...
with tf.Session() as sess:
    ...
    for i in range(num_episodes):
        ...
        if i % 3000 == 0 and i != 0:
            ...
            saver.save(sess, restoring_backup_folder + 'double-dueling-recurrent-dqn', global_step=i)
            with open(restoring_backup_folder + 'double-dueling-recurrent-dqn-' + str(i) + ".pickle", 'wb') as file:
                dictionary = {
                    "epsilon": e,
    ...
    saver.save(sess, 'double-dueling-recurrent-dqn', global_step=i)
#end    
